...
@echo [101mg++ %* -std=c++14  [0m
@g++ %* -IA:\\CMC_HEADER -std=c++14 -lstdc++exp -o gout.exe
...
@echo [101mcl %* /std:c++14 [0m
@cl  %* /IA:\\CMC_HEADER /permissive- /std:c++14 /utf-8 /nologo /EHsc /link /out:vout.exe
